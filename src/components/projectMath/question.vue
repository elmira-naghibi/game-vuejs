...
export default {
  ...
  methods: {
    generateQuestion() {
      ...
      console.log("btnData", "correctAnswer", correctAnswer);
      ...
      console.log(this.btnData[correctButton].answer)

    },
    generateRandomNumber( min, max, except) {
      const rndNumber = Math.round(Math.random() * (max - min)) + min;
      console.log("min=",min,"max=", max,"random=",rndNumber,"except",except);
      if (rndNumber == except) {
